...
microbenchmark(trim_wl(my.spct, range = c(400, 700), use.hinges = FALSE))
microbenchmark(trim_wl(my.spct, range = c(400, NA), use.hinges = FALSE))
microbenchmark(trim_wl(my.spct, range = c(NA, 700), use.hinges = FALSE))
