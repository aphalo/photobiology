...
test_that("numeric", {
  ...
  expect_equal(names(color_of(200)), "wl.200.nm")
  expect_equal(unname(color_of(430)), "#1F00FF")
  expect_equal(names(color_of(430)), "wl.430.nm")
  expect_equal(unname(color_of(430, chroma.type = "CMF")), "#1F00FF")
  expect_equal(names(color_of(430, chroma.type = "CMF")), "wl.430.nm")
  expect_equal(unname(color_of(430, chroma.type = "CC")),  "#1000E0")
  expect_equal(names(color_of(430, chroma.type = "CC")), "wl.430.nm")
  expect_equal(unname(color_of(c(460, 500, 600))),  c("#0000FF", "#00A92E", "#FF2E00"))
  expect_equal(names(color_of(c(460, 500, 600))), c("wl.460.nm", "wl.500.nm" ,"wl.600.nm"))
  expect_equal(unname(color_of(c(460, 500, 600), chroma.type = "CMF")), c("#0000FF", "#00A92E", "#FF2E00"))
  expect_equal(names(color_of(c(460, 500, 600), chroma.type = "CMF")), c("wl.460.nm", "wl.500.nm" ,"wl.600.nm"))
  expect_equal(unname(color_of(c(460, 500, 600), chroma.type = "CC")), c( "#0000DD", "#00FF4E", "#FF1900"))
  expect_equal(names(color_of(c(460, 500, 600), chroma.type = "CC")), c("wl.460.nm", "wl.500.nm" ,"wl.600.nm"))
})
