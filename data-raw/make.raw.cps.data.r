...
white_led.cps_spct <- s_irrad_corrected(led_desk201.raw_spct, correction.method = MAYP11278_ylianttila.mthd, return.cps = TRUE)
white_led.source_spct <- s_irrad_corrected(led_desk201.raw_spct, correction.method = MAYP11278_ylianttila.mthd)
