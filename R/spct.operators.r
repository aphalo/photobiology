...
oper.e.generic_spct <- function(e1, e2, oper) {
  ...
  if (class1 == "cps_spct") {
    ...
    if (is.numeric(e2)) {
      ...
      z <- data.table(w.length=x$w.length, x=x[["s.irrad"]], y=y[["s.irrad"]], z=z[["s.irrad"]])
      setChromaSpct(z)
      return(z)
    ...
    if (is.numeric(e2)) {
      ...
      z[ , s.e.response := oper(s.e.response, e2)]
      return(z)
    } else if (class2 == "response_spct") {
...
oper.q.generic_spct <- function(e1, e2, oper) {
  ...
  if (class1 == "cps_spct") {
    ...
    if (is.numeric(e2)) {
      ...
      z[ , s.q.response := oper(s.q.response, e2)]
      return(z)
    }  else if (class2 == "response_spct") {
