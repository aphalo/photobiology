...
#'
#' day_night(ymd("2015-05-30", tz = "Europe/Helsinki"),
#'           geocode = my.geocode)
#' day_night(ymd("2015-05-30", tz = "Europe/Helsinki") + days(1:10),
#'           geocode = my.geocode,
#'           twilight = "civil")
#' sunrise_time(ymd("2015-05-30", tz = "Europe/Helsinki"),
#'              geocode = my.geocode)
#' noon_time(ymd("2015-05-30", tz = "Europe/Helsinki"),
#'           geocode = my.geocode)
#' sunset_time(ymd("2015-05-30", tz = "Europe/Helsinki"),
#'             geocode = my.geocode)
#' day_length(ymd("2015-05-30", tz = "Europe/Helsinki"),
#'            geocode = my.geocode)
#' day_length(ymd("2015-05-30", tz = "Europe/Helsinki"),
#'            geocode = my.geocode,
#'            unit.out = "day")
#' is_daytime(ymd("2015-05-30", tz = "Europe/Helsinki") + hours(c(0, 6, 12, 18, 24)),
#'            geocode = my.geocode)
#' is_daytime(ymd_hms("2015-05-30 03:00:00", tz = "Europe/Helsinki"),
#'            geocode = my.geocode)
