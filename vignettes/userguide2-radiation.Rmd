...
Functions `setWhereMeasured()` and `getWhereMeasured()` are used for setting or getting a geocode stored in a `data.frame`. This format is compatible with function `geocode()` from package `ggmap`. We pass latitude and longitude coordinates, as shown below. The returned value is always a data frame with columns `"lon"` and `"lat"`.
...
|:--------------------|:----------|:---------------|:------------------------|
| `sum`| `source_mspct` | `source_spct` | same as input |
| `sum` | `response_mspct` | `response_spct` | same as input |
| `sum` | `filter_mspct` | `generic_spct` | input tagged `.sum` |
| `sum` | `reflector_mspct` | `generic_spct` | input tagged `.sum` |
| `sum` | `calibration_mspct` | `generic_spct` | input tagged `.sum` |
| `prod`| `source_mspct` | `source_spct` | input tagged `.prod`  |
| `prod` | `response_mspct` | `response_spct` | input tagged `.prod`  |
| `prod` | `filter_mspct` | `filter_spct` | same as input |
| `prod` | `reflector_mspct` | `reflector_spct` | same as input |
| `prod` | `calibration_mspct` | `generic_spct` | input tagged `.prod` |
| `s_mean`, `s_median` or `s_mean_se`| `source_mspct` | `source_spct` | same as input |
| `s_mean`, `s_median` or `s_mean_se` | `response_mspct` | `response_spct` | same as input |
| `s_mean`, `s_median` or `s_mean_se` | `filter_mspct` | `filter_spct` | same as input |
| `s_mean`, `s_median` or `s_mean_se` | `reflector_mspct` | `reflector_spct` | same as input |
| `s_mean`, `s_median` or `s_mean_se` | `calibration_mspct` | `calibration_spct` | same as input |
...
| `s_var`, `s_se` or `s_sd` | `reflector_mspct` | `reflector_spct` | input tagged `.var`, `.se` or `.sd` |
