...
The _usual_ and three new summary methods are available for spectra, but redefined to return wavelength-based summaries in nanometres (nm). For clarity synonims with clearer names are provided. The three new generic methods `midpoint()`, `expanse()` and  `stepsize()` are
