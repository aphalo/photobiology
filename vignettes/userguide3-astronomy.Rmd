...
There are several different emperical equations in common use to estimate
...
anciliary functions help with unit conversion and computation of relative
humidity.
...
Saturation water vapour mass/volume concentration for air at 20 C, expresed in
...
water_RH2vp(50, 20)
```
And the inverse computation, RH from vapour pressure in Pa and air temperarture in C.
