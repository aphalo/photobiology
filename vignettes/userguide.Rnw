...
Two functions allow calculation of simulated colour of light sources as R colour definitions for monochromatic
and polychromatic light. By default CIE coordinates for \textit{typical} human vision are used, but the functions
