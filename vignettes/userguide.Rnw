...
setWhenMeasured(my.spct, ymd_hms("2015-10-31 22:55:00 EET"))
getWhenMeasured(my.spct)
@
...
setWhenMeasured(two.mspct, ymd("2015-10-31 UTC"))
getWhenMeasured(two.mspct)
setWhenMeasured(two.mspct,
                list(ymd_hm("2015-10-31 10:00 UTC"),
                     ymd_hm("2015-10-31 11:00 UTC")))
getWhenMeasured(two.mspct)
@
