...
\newcommand{\N}{\textcolor{red}{\small N}}
\newcommand{\Y}{\textcolor{green}{\small Y}}
\caption[Binary operators]{Unary operators and maths functions. Validity and class of result. All operations marked `\Y' are allowed, those marked `\N' are not implemented and return \texttt{NA} and issue a warning.}\label{tab:unary}

\centering
\begin{footnotesize}
\begin{tabular}{>{\ttfamily}lccccccc>{\ttfamily}l}
\toprule
e1 & \verb|+| & \verb|-| & \verb|log| & \verb|log10| & \verb|exp| & \verb|sqrt| & \verb|abs| & \textnormal{value} \\
\midrule
...
\begin{table}
  ...
  \begin{tabular}{>{\ttfamily}lcccccc}
    ...
    labels & l & l & l & l & l & l \\
    summary & l & l & l & l & l & l \\
    peaks & ms & ms & ms & ms & ms & ms \\
    valleys & ms & ms & ms & ms & ms & ms \\
    integrate\_spct & a, d & a, d & a, d & a, d & d & d \\
    average\_spct & a, d, l & a, d, l & a, d, l & d & d, l & d, l \\
    color & + & -- & d, l & d, l & -- & d, l \\
    \bottomrule
  \end{tabular}
  \end{footnotesize}
