...
Setting \texttt{strict.range = TRUE} issues an instead of a warning.
...
trim_spct(my_sun.spct, low.limit = 297, byref = TRUE)
@
...
<<>>=
trim_spct(sun.spct, low.limit = 297, fill = NA)
@
