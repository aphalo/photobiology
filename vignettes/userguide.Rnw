...
<<>>=
noon_time(dates, lat =  60, tz = "UTC")
noon_time(dates, lat =  60, tz = "CET")
@
...
<<>>=
sunrise_time(today(tzone = "EET"), lat = 60, lon = 25, tz = "EET", twilight = "civil")
sunrise_time(today(tzone = "EET"), lat = 60, lon = 25, tz = "EET", twilight = -10)
sunrise_time(today(tzone = "EET"), lat = 60, lon = 25, tz = "EET", twilight = +12)
@
