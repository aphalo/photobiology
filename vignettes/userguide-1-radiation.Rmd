...
| `solute_spct`       | `w.length`, `K.mol`       | `K.type`, `solute,prperties`                        |
...
| x, y, z                     | [0,1]                                   |                        |
| K.mol                      | $m^{-1}, \log_{10}$ based               | K.type = "attenuation" |
| K.mol                      | $m^{-1}, \log_{10}$ based               | K.type = "absorption"  |
| K.mol                      | $m^{-1}, \log_{10}$ based               | K.type = "scattering"  |
| **B: converted**            |                                         |                        |
| wl $\to$ w.length           | nm                                      |                        |
...
| K.mol                      | $m^{-1}, \log_{e}$ based                | K.type = "attenuation" |
| K.mol                      | $m^{-1}, \log_{e}$ based                | K.type = "absorption"  |
| K.mol                      | $m^{-1}, \log_{e}$ based                | K.type = "scattering"  |
