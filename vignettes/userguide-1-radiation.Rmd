...
Frequently, we are not interested in all local maxima, but instead only in those that exceed a certain heigh globally or locally (within the window of width `span`). Arguments paased to additional parameters make this possible as described in the help page of `peaks()` methods.
