...
Passing `eval="collection"` we obtain the same condensed summary as shown above
...
Passing `eval="each"` we obtain the same expanded summary as shown above
for `eval="each"` for collections of spectra. (Output not shown here.)
