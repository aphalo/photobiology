...
//'
//' @usage put_hinges(w_length, s_irrad, hinges)
//'
...
//
// [[Rcpp::export]]
NumericVector put_hinges(NumericVector w_length, NumericVector s_irrad, NumericVector hinges) {
  ...
  cout << "h_high idx: " << distance(hinges_in.begin(), h_high) <<  "\n";
    ...
    vector<double>::size_type max_len = w_length_in.size() + hinges.size();
